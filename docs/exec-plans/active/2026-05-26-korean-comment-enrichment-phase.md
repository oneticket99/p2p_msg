...
| T-6 | M5 | `app/rtc/*.py` 상태 머신 전이·DataChannel 계약·메모리 release 의도 주석 | main session | T-5 | 영역 diff 비주석 0 + pytest 전량 무변경 PASS | `app/rtc/*.py` (8) | 🔄 5/8 (b1 mesh·peer_conn, b2 image_processor·protocol·__init__, 잔여 peer·file_sender·file_receiver) |
