...
| T-5 | M4 | `app/net/*_client.py` REST 계약·재시도/타임아웃·SSL 우회 의도 주석 | main session | T-4 | 영역 diff 비주석 0 + pytest 전량 무변경 PASS | `app/net/*_client.py` (16) | 🔄 3/16 (b1 _ssl_util·group_message·push) |
