...
| avatar 이미지 picker (그룹/채널/프로필 3 dialog + 파일/카메라/클립보드 + 표시 전파) | 🟡 M1~M6 코드 완결 (서버 영속 0018 + AvatarPickerButton + 3 dialog 통합 + 서버 room kind 0019 + 카메라 CameraCaptureDialog + AvatarCache 표시 전파 6 site). M7 문서/G-final 실 webcam visual ack 잔존 |
