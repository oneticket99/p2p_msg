...
[2026-05-17 13:40:44] AGENTS.md PR 게이트 체크리스트 — build.yml (M5 PyInstaller 매트릭스) 행 추가 + Phase 1 active 명시. CI 워크플로우 3 → 4 (build.yml = Phase 1 후반 신설 예정). 실행계획 §6 측 build.yml 등재 정합 (커밋 대기)
