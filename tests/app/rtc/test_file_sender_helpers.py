...
검증 대상:
- ``_env_int`` — file_receiver 와 동일 시그니처 별도 모듈 정합 검증
...
class TestEnvInt:
    ...
    def test_invalid_falls_back(
        ...
        # int() float / hex / scientific 모두 거부
...
class TestSha256OfFile:
    ...
    def test_empty_file(self, tmp_path: Path) -> None:
        ...
        target.touch()
        # 빈 파일 sha256 = e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
    ...
    def test_multi_chunk_boundary(self, tmp_path: Path) -> None:
        # 64 KiB chunk_size 의 의 정확히 2 chunk 경계 정합
