...
- [2026-05-17 12:46:09] vibe-coding.md 평가 snapshot 갱신 + HTML 2종 재생성 (sub-agent 병렬) + 영구 메모리 feedback-doc-perfection-before-code 신설 (큰 프로젝트 측 8 체크리스트 의무 + 간단 작업 완화) (docs/assessments/ + docs/html/ + 메모리)
