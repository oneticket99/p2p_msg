...
- [2026-05-23 23:19:58] 검증 게이트 self-consistency 회수 — markdownlint MD049 + meta-enforcement soft-fail 충돌 정리 (History.md · .github/workflows/ci.yml · .github/workflows/docs-lint.yml · CheckList.md)
