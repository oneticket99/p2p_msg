...
- **P3 임시 협업 사용자** — 외부 디자이너·번역가·1회성 컨설턴트. 회사 메신저 계정 발급은 과하고, 이메일 첨부는 용량 제약이 있다. TooTalk 의 1:1 직결·세션 종료 시 흔적 최소화 특성이 핵심. **가입 마찰 (재조정 2026-05-17)**: 사용자 directive — TooTalk 이용 의 회원가입 의무 도입. P3 의 가치 = "가입 마찰 0" → "가입 마찰 최소" 재조정 (3 필수 필드 + OTP 3분, 1회 가입 후 영구 이용). 가입 마찰 분산 — 1회 마찰 후 향후 사용 마찰 0 ([[project-auth-email-otp-required]] 정합).
