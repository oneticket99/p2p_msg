...
| Talk QLabel font-size | **38 px** | font-weight 700 + letter-spacing -1px + family `-apple-system, 'SF Pro Display', 'Inter', sans-serif` (cycle 169.18 — 28 → 38 35% 증가) |
| symbol:Talk ratio | **50 : 38 ≈ 1.32** | 모든 dialog (Welcome + Login + Signup) 동일 의무 |
