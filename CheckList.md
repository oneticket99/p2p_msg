...
| FR P0/P1              | 0 / 10          | FR-01 ~ FR-10 — 코드 진입 전 (사용자 GO 대기)                       |
| NFR                   | 0 / 7           | NFR-01 ~ NFR-07 — 측정 인프라 부분 구축 (pytest + Playwright 스켈레톤) |
| 마일스톤              | M1 in_progress  | M2 ~ M5 pending (실행계획 §4 정합)                                 |
| CI 워크플로우         | 3 / 4           | ci · docs-lint · doc-gardener active. build.yml = M5 단계 (Phase 1 후반) |
| self-hosted runner    | 0 / 2           | macOS arm64 + Windows x64 — docs/references/ci-self-hosted-setup.md 절차 (사용자 직접) |
