...
| FR P0/P1              | 7 / 13 done · 2 partial | FR-01/02/06/07/08/09/10 done · FR-03/04 binding 완료 + image/file E2E 부재 · FR-05 server PASS + 클라 SQLite cache active · FR-11/12/13 회원가입/로그인 binding 완료 |
...
| `[~]` | FR-04 | 파일 송수신 + 양방향 ProgressBar   | file_sender + file_receiver + file_progress_widget                                                               | [app/rtc/file_sender.py](app/rtc/file_sender.py) · [app/rtc/file_receiver.py](app/rtc/file_receiver.py) · [app/ui/file_progress_widget.py](app/ui/file_progress_widget.py) | binding 완료 / 100MB E2E 부재 |
