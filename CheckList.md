...
## 2. 진행률 요약 (2026-05-17 기준 — 본 세션 누계 commit 18+ 반영)
...
| CI 워크플로우         | 3 / 4 (GREEN)   | ci (8 job GREEN — Windows matrix 임시 비활성) · docs-lint · doc-gardener 모두 macOS-arm64 GREEN 도달 (2026-05-17 15:40). build.yml = M5 단계 (Phase 1 후반) |
| self-hosted runner    | 1 / 2           | macOS arm64 등록 OK (id=2 online, launchd PID 62533, workflow 픽업 검증) + Windows x64 미등록 — docs/references/ci-self-hosted-setup.md 절차 |
