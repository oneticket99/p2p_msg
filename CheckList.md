...
| FR P0/P1              | 8 / 13 done · 1 partial | FR-01/02/04/06/07/08/09/10 done · FR-03 binding 완료 + image multi-chunk E2E 부재 · FR-05 server PASS + 클라 SQLite cache active · FR-11/12/13 회원가입/로그인 binding 완료 |
...
| `[~]` | FR-03 | 이미지 송수신 (썸네일 + 원본)      | image_processor + message_bubble PIL bbox                                                                        | [app/rtc/file_sender.py](app/rtc/file_sender.py) · [app/rtc/image_processor.py](app/rtc/image_processor.py) · [app/ui/message_bubble.py](app/ui/message_bubble.py) | binding 완료 / E2E 부재 |
