...
| `[~]` | FR-05 | 메시지 영속화 (MariaDB)            | mariadb 11 + 9 table + bcrypt 12 + cycle 169.502 bot user ensure                                                 | [server/db/](server/db/) · [app/db/messages_cache.py](app/db/messages_cache.py)                | server PASS / 클라 SQLite 의 의 활성 |
