...
| `[~]` | NFR-02| 성능    | 100MB 파일 송신 throughput (LAN)            | ≥ 30Mbps 평균                       | `tools/bench_transfer.py` (cycle 169.593 측정 인프라 신설, demo signaling relay 22.24 Mbps — DataChannel 직결 측정 별 cycle) |
