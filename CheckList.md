...
| FR P0/P1              | 6 / 13 done · 3 partial | FR-01/06/07/08/09/10 done · FR-02/03/04 binding 완료 + E2E 부재 · FR-05 server PASS + 클라 SQLite cache active (cycle 169.598) · FR-11/12/13 회원가입/로그인 binding 완료 |
...
| `[~]` | FR-02 | DataChannel 텍스트 송수신          | cycle 153.7 InputBar + ChatSendMixin (169.527) + RoomGroupChat (169.521)                                         | [app/rtc/peer.py](app/rtc/peer.py) · [app/ui/chat_view.py](app/ui/chat_view.py)                          | binding 완료 / E2E 부재 |
